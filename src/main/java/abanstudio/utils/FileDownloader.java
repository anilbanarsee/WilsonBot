...
public class FileDownloader {
    ...
    public static File downloadFile(String fileURL, String saveDir)
            throws IOException, InvalidDownloadException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            if(!contentType.matches("(audio)|(video)")){
                throw new InvalidDownloadException("type");
            }
            if(contentLength>=3145728){
                throw new InvalidDownloadException("size");
            }
        ...
        if(saveFilePath.equals("")){
            System.out.println("returning null file");
            return null;
        }
